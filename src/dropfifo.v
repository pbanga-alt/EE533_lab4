...
// /___/   /\     Timestamp : 01/29/2026 16:15:43
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Syncadder_8bit_schematic/Instrusion_Detection_System/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   reg9B XLXI_11 (.ce(XLXN_18), 
                  .clk(clk), 
                  .clr(), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_20[71:0]));
   OR2 XLXI_26 (.I0(XLXN_2), 
                .I1(XLXN_1), 
                .O(XLXN_3));
   AND2B1 XLXI_27 (.I0(XLXN_36), 
                   .I1(XLXN_3), 
                   .O(XLXN_23));
   FDC XLXI_28 (.C(clk), 
                .CLR(rst), 
   ...
   VCC XLXI_29 (.P(XLXN_18));
   dualportmem XLXI_31 (.addra(waddr[7:0]), 
                        .addrb(XLXN_34[7:0]), 
                        .clka(clk), 
                        .clkb(clk), 
                        .dina(XLXN_20[71:0]), 
